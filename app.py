    ...
    try:
        ...
        if user_data and user_data[0] and user_data[1]:
            ...
            if user.id in ADMIN_IDS:
                keyboard = [['🍽 ምግብ ዝርዝር'], ['🔐 ምግብ ዝርዝር አዘምን', '🔐 ምግብ ዝርዝር ሰርዝ'], ['🔐 ተመዝጋቢዎችን ተመልከት']]
            else:
                keyboard = [['📋 ይመዝገቡ', '💬 ድጋፍ']]
            await update.message.reply_text(
                onboarding_text,
...
async def send_help_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user.id not in ADMIN_IDS:
        commands_text += "🛒 /subscribe - የምዝገባ እቅድ ይምረጡ\n🍴 /select_meals - ምግቦችዎን ይምረጡ\n"
